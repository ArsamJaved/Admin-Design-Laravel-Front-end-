...
<div class="content">
    <div id="lead-details">
        <div class="p-md-4 p-3">
            ...
            <div>
                <h4 class="mb-4 fw-bold">Add New Property</h4>
                        ...
                        <div class="col-xl-4 order-xl-1">
                            <div class="scrollbar-tabs mb-4">
                                <ul class="nav justify-content-between flex-nowrap nav-wizard nav-wizard-vertical-xl" data-tab-map-container="data-tab-map-container" role="tablist">
                                    <li class="nav-item" role="presentation"><a class="nav-link active py-0 py-xl-3" href="#add-property-wizard-tab1" data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-file nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                                    ...
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Info</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab2" data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-location-dot nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-dot" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path>
                                                        </svg>
                                                        <svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg>
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Location</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab3" data-bs-toggle="tab" data-wizard-step="3" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-mug-saucer nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="mug-saucer" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M96 64c0-17.7 14.3-32 32-32H448h64c70.7 0 128 57.3 128 128s-57.3 128-128 128H480c0 53-43 96-96 96H192c-53 0-96-43-96-96V64zM480 224h32c35.3 0 64-28.7 64-64s-28.7-64-64-64H480V224zM32 416h644c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32z"></path>
                                                        </svg><!-- <span class="fa-solid fa-mug-saucer nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg>
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Amenities</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab4" data-bs-toggle="tab" data-wizard-step="4" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3">
                                                <span class="nav-item-circle-parent"><span class="nav-item-circle">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                                            <g fill="none">
                                                                <path fill="currentColor" fill-rule="evenodd" d="M3.172 3.172C2 4.343 2 6.229 2 10v4c0 3.771 0 5.657 1.172 6.828S6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14v-4c0-2.84 0-4.61-.5-5.811V17a3.62 3.62 0 0 1-2.56-1.06l-.752-.752c-.722-.722-1.082-1.082-1.491-1.234a2 2 0 0 0-1.394 0c-.409.152-.77.512-1.49 1.234l-.114.113c-.585.585-.878.878-1.189.932a1 1 0 0 1-.699-.134c-.268-.166-.431-.547-.758-1.308L11 14.667c-.75-1.75-1.124-2.624-1.778-2.952a2 2 0 0 0-1.065-.205c-.729.062-1.401.735-2.747 2.08L3.5 15.5V2.887q-.174.129-.328.285" clip-rule="evenodd" />
                                                    ...
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Photos</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab5" data-bs-toggle="tab" data-wizard-step="5" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-dollar-sign nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="dollar-sign" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                                        ...
                                                        </svg><!-- <span class="fa-solid fa-usd nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg>
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Finance</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab6" data-bs-toggle="tab" data-wizard-step="6" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-shield-halved nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shield-halved" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                        ...
                                                        </svg><!-- <span class="fa-solid fa-shield-halved nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg>
                                                    </span></span><span class="nav-item-title fs-9 fs-xl-8">Policies</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-property-wizard-tab7" data-bs-toggle="tab" data-wizard-step="7" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-check" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg><!-- <span class="fas fa-check"></span> Font Awesome fontawesome.com --></span></span><span class="nav-item-title fs-9 fs-xl-8">Done</span></div>
                                        </a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" role="tabpanel" aria-labelledby="add-property-wizard-tab1" id="add-property-wizard-tab1">
                                            <form id="addPropertyWizardForm1" data-wizard-form="1">
                                                ...
                                                <h5 class="mb-4 fw-bold">Property Information</h5>
                                                <div class="form-floating"><input class="form-control" type="text" name="add-property-wizard-name" id="add-property-wizardwizard-name" placeholder="Property Name" value="With help text"><label for="add-property-wizardwizard-name">Property Name</label>
                                                    <h6 class="text-end text-body-quaternary fw-semibold mt-2"><span class="text-primary">15 </span>/ 60</h6>
                                                </div>
                                                <div class="form-floating my-3"><textarea class="form-control" placeholder="Description" name="add-property-wizard-message" id="add-property-wizard-wizard-des" style="height: 162px"></textarea><label for="add-property-wizard-wizard-des">DESCRIPTION</label>
                                                    <h6 class="text-end text-body-quaternary fw-semibold mt-2"><span class="text-primary">0 </span>/ 360</h6>
                                                </div>
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4 col-lg-12 col-xl-4">
                                                        <div class="form-icon-container">
                                                            <div class="form-floating"><select class="form-select form-icon-input" name="add-property-wizard-type" id="add-property-wizardrating-type">
                                                                ...
                                                                </select><label class="text-body-tertiary form-icon-label ms-3" for="add-property-wizardrating-type">Rating</label></div><svg class="svg-inline--fa fa-star text-warning form-icon fs-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                <path fill="currentColor" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path>
                                                            </svg><!-- <span class="fa-solid fa-star text-warning form-icon fs-10"></span> Font Awesome fontawesome.com -->
                                                        </div>
                                                    </div>
                                                </div>
                                                <h5 class="mt-4 form-icon-label ms-3 mb-3">Contact Information</h5>
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                ...
                                                <h5 class="mt-4 form-icon-label ms-3 mb-3">Is it part of a hotel / property chain?</h5>
                                                ...
                                                <h5 class="mt-4 form-icon-label ms-3 mb-3">Do you use a Channel Management Systems?</h5>
                                                <div class="row align-items-center g-3">
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-9 flex-1">
                                                        <div class="form-floating"><input class="form-control" type="text" name="add-property-wizard-cms" id="add-property-wizardwizard-cms" placeholder="CMS Provider name" value=""><label for="add-property-wizardwizard-cms">CMS Provider name</label><svg class="svg-inline--fa fa-magnifying-glass position-absolute text-body-quaternary fs-9 end-0 top-0 mt-3 me-3" data-fa-transform="down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.625em;">
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab2" id="add-property-wizard-tab2">
                                            <form id="addPropertyWizardForm2" novalidate="novalidate" data-wizard-form="2">
                                                ...
                                                <div class="form-icon-container">
                                                    <div class="form-floating"><input class="form-control form-icon-input" type="text" name="add-property-wizard-search-address" id="add-property-wizardwizard-search-address" placeholder="Search address..."><label class="text-body-tertiary form-icon-label ms-3" for="add-property-wizardwizard-search-address">Search address...</label></div><svg class="svg-inline--fa fa-location-dot text-body form-icon fs-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-dot" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                                        <path fill="currentColor" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path>
                                                ...
                                                <div class="mapbox-container rounded-3 border overflow-hidden mt-3 mb-4">
                                                    <div id="mapbox" data-mapbox="{&quot;attributionControl&quot;:false,&quot;center&quot;:[-74.0020158,40.7228022],&quot;zoom&quot;:14,&quot;scrollZoom&quot;:false}" style="height: 250px" class="mapboxgl-map">
                                                        ...
                                                        <div class="mapboxgl-canvas-container mapboxgl-interactive mapboxgl-touch-drag-pan mapboxgl-touch-zoom-rotate"><canvas class="mapboxgl-canvas" tabindex="0" aria-label="Map" role="region" width="600" height="450" style="width: 400px; height: 300px;"></canvas>
                                                ...
                                                <div class="d-flex align-items-center gap-3 mt-4 text-body-tertiary form-icon-label ms-3">
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab3" id="add-property-wizard-tab3">
                                            <form id="addPropertyWizardForm3" novalidate="novalidate" data-wizard-form="3">
                                                <div>
                                                    <h4 class="mb-4">General amenities</h4>
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-sm-auto"><button class="btn btn-phoenix-primary w-100 h-100 fs-8"><svg class="svg-inline--fa fa-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                ...
                                                                Add amenity</button></div>
                                                    </div>
                                                </div>
                                                <div class="accordion-button-arrow-icon accordion mt-2" id="generalAmenitiesAccordion">
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight" type="button" data-bs-toggle="collapse" data-bs-target="#popularAmenities" aria-expanded="true" aria-controls="popularAmenities"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-fire" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="fire" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    ...
                                                                    </svg><!-- <span class="fa-solid fa-fire"></span> Font Awesome fontawesome.com --></span><span class="flex-1">Popular amenities</span></button></h6>
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#foodAndDrink" aria-expanded="false" aria-controls="foodAndDrink"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-utensils" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="utensils" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    ...
                                                                    </svg><!-- <span class="fa-solid fa-utensils"></span> Font Awesome fontawesome.com --></span><span class="flex-1 me-2">Food &amp; Drink</span></button></h6>
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#outdoorAndView" aria-expanded="false" aria-controls="outdoorAndView"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-umbrella-beach" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="umbrella-beach" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                        <path fill="currentColor" d="M346.3 271.8l-60.1-21.9L214 448H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h644c17.7 0 32-14.3 32-32s-14.3-32-32-32H282.1l64.1-176.2zm121.1-.2l-3.3 9.1 67.7 24.6c18.1 6.6 38-4.2 39.6-23.4c6.5-78.5-23.9-155.5-80.8-208.5c2 8 3.2 16.3 3.4 24.8l.2 6c1.8 57-7.3 113.8-26.8 167.4zM462 99.1c-1.1-34.4-22.5-64.8-54.4-77.4c-.9-.4-1.9-.7-2.8-1.1c-33-11.7-69.8-2.4-93.1 23.8l-4 4.5C272.4 88.3 245 134.2 226.8 184l-3.3 9.1L434 269.7l3.3-9.1c18.1-49.8 26.6-102.5 24.9-155.5l-.2-6zM107.2 112.9c-11.1 15.7-2.8 36.8 15.3 43.4l71 25.8 3.3-9.1c19.5-53.6 49.1-103 87.1-145.5l4-4.5c6.2-6.9 13.1-13 20.5-18.2c-79.6 2.5-154.7 42.2-201.2 108z"></path>
                                                                    </svg><!-- <span class="fa-solid fa-umbrella-beach"></span> Font Awesome fontawesome.com --></span><span class="flex-1 me-2">Outdoor &amp; View</span></button></h6>
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#intertainment" aria-expanded="false" aria-controls="intertainment"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-cart-shopping" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cart-shopping" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                        <path fill="currentColor" d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"></path>
                                                                    </svg><!-- <span class="fa-solid fa-cart-shopping"></span> Font Awesome fontawesome.com --></span><span class="flex-1 me-2">Entertainment &amp; Family Services</span></button></h6>
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#mediaAndTechnology" aria-expanded="false" aria-controls="mediaAndTechnology"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-video" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="video" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                    ...
                                                                    </svg><!-- <span class="fa-solid fa-video"></span> Font Awesome fontawesome.com --></span><span class="flex-1 me-2">Media &amp; Technology</span></button></h6>
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accessibility" aria-expanded="false" aria-controls="accessibility"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-universal-access" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="universal-access" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                                    ...
                                                                    </svg><!-- <span class="fa-solid fa-universal-access"></span> Font Awesome fontawesome.com --></span><span class="flex-1 me-2">Accessibility</span></button></h6>
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab4" id="add-property-wizard-tab4">
                                            <form id="addPropertyWizardForm4" novalidate="novalidate" data-wizard-form="4">
                                                <h4 class="mb-4">Add property picture</h4>
                                                <div class="dropzone dropzone-multiple p-0 mb-4 dz-clickable" id="my-awesome-dropzone" data-dropzone="data-dropzone">
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab5" id="add-property-wizard-tab5">
                                            <form id="addPropertyWizardForm5" novalidate="novalidate" data-wizard-form="5">
                                                ...
                                                <h5 class="mb-4">Payment from Phoenix Booking Management</h5>
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                ...
                                                <h5 class="mt-4 text-body-tertiary form-icon-label ms-3 mb-4">Payment from Guests (On property)</h5>
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab6" id="add-property-wizard-tab6">
                                            <form id="addPropertyWizardForm6" novalidate="novalidate" data-wizard-form="6">
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Checkout Policy</h5>
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Cancellation Policy</h5>
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Pet Policy</h5>
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Child Policy</h5>
                                                <h6 class="mb-2 text-body">Age Segment 1</h6>
                                                <div class="row align-items-center g-3">
                                                ...
                                                <h6 class="mb-2 mt-4 text-body">Age Segment 2</h6>
                                                <div class="row align-items-center g-3">
                                                    <div class="col-6 col-sm-auto">
                                                ...
                                                <h6 class="mb-2 mt-4 text-body"> <span>Age Segment 3</span><button class="btn btn-link p-0 ms-1">Remove</button></h6>
                                                <div class="row align-items-center g-3">
                                                    <div class="col-6 col-sm-auto">
                                                ...
                                                <button class="btn btn-link p-0 mt-3 fs-8"><svg class="svg-inline--fa fa-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                        <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                                    </svg>
                                                    Add Segment</button>
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Included Taxes in your rate</h5>
                                                <div class="form-price-tier border p-3 rounded-2 mb-3" data-form-price-tier="data-form-price-tier">
                                                    <div class="d-sm-flex align-items-center gap-3">
                                                ...
                                                <h5 class="mb-4 mt-4 text-body-tertiary form-icon-label ms-3">Your Documentations</h5>
                                        ...
                                        <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab7" id="add-property-wizard-tab7">
                                            <h4 class="mb-2">We’re building your property</h4>
                                            <p class="mb-4 text-body-tertiary">We're working on getting your property set up and ready for guests. Stay tuned for updates and start accepting bookings soon!</p>
                                            ...
                                            <div class="accordion-button-arrow-icon accordion mt-2" id="previewAccordion">
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight" type="button" data-bs-toggle="collapse" data-bs-target="#basicInfo" aria-expanded="true" aria-controls="basicInfo"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/info.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/info_dark.svg" alt=""><span class="fs-sm-7">Basic Information</span></button></h6>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Property name</h6>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Property Information</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Property type</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Rating</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Email address</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Mobile number</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Property chain</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">CMS</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">CMS provider name</h6>
                                                                        </td>
                                                ...
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#location" aria-expanded="true" aria-controls="location"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/location.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/location_dark.svg" alt=""><span class="fs-sm-7">Location</span></button></h6>
                                                        ...
                                                        <div class="mt-4 scrollbar"><a class="fs-9 fw-semibold mb-2 d-inline-block" href="#!">Edit location</a>
                                                            <table class="w-100">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Apartment / Street</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">State</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Country / Region</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">City</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Zip code</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                ...
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#generalAmenities" aria-expanded="true" aria-controls="generalAmenities"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/bed-double.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/bed-double_dark.svg" alt=""><span class="fs-sm-7">General Amenities</span></button></h6>
                                                        ...
                                                        <div class="mt-4 scrollbar"><a class="fs-9 fw-semibold mb-2 d-inline-block" href="#!">Edit amenities</a>
                                                            <table class="w-100">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Wifi</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Hotel Bar</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Restaurant</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Common Areas</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Pool</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Tennis Courts</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">No Smoking</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Air Conditioning</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Parking</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Bathtub</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Beach View</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap  pb-3">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Flat-screen TV</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-top pt-3 text-nowrap">
                                                                            <h6 class="fw-semibold text-body-highlight mb-0">Balcony</h6>
                                                                        </td>
                                                                        <td class="border-top px-3 pt-3 w-max-content">
                                                                            <p class="mb-0 w-max-content">:</p>
                                                                        </td>
                                                ...
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#pictures" aria-expanded="true" aria-controls="pictures"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/picture.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/picture_dark.svg" alt=""><span class="fs-sm-7">Picture</span></button></h6>
                                                ...
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#finance" aria-expanded="true" aria-controls="finance"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/dollar-alt.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/dollar-alt_dark.svg" alt=""><span class="fs-sm-7">Finance</span></button></h6>
                                                    <div class="accordion-collapse collapse" id="finance" data-bs-parent="#previewAccordion">
                                                        <div class="mt-4"><a class="fs-9 fw-semibold mb-2 d-inline-block" href="#!">Edit finance</a>
                                                            <h6 class="fw-bolder mb-3">Payment from PBM</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Payment currency</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Payment method</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Received payment</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Card type</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Card number</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Card holder name</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Commission Percentage</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Invoice email</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="fw-bolder mb-3 mt-4">Payment from Guests (On property)</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Cash payment</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Card Payment</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">MFS / Online Payment</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                ...
                                                <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-4">
                                                    <h6 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#policy" aria-expanded="true" aria-controls="policy"><img class="me-2 d-dark-none" src="../../../../assets/img/icons/file-check-alt.svg" alt=""><img class="me-2 d-light-none" src="../../../../assets/img/icons/file-check-alt_dark.svg" alt=""><span class="fs-sm-7">Policy</span></button></h6>
                                                    <div class="accordion-collapse collapse" id="policy" data-bs-parent="#previewAccordion">
                                                        <div class="mt-4"><a class="fs-9 fw-semibold mb-2 d-inline-block" href="#!">Edit policies</a>
                                                            <h6 class="mb-3 fw-bolder">Check-in-Policy</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Check-in type</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Check-in start</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Age Restriction</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Deposit at Check-in</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Documentation at Check-in</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Late check-in</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Check-in end</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Checkout Policy</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Checkout before</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Flexible Checkout</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Type</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Amount</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Cancellation Policy</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Full refund</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Partial refund</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Pet Policy</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Pet Restricted Zones</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Additional Charges</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Child Policy</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Age Segment 1</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Age Segment 2</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Age Segment 3</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Documentation Requirement</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Included Taxes in your rate</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Vat</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">GST</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Hotel tax</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">City / District tax</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Tourist tax</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                            ...
                                                            <h6 class="mb-3 fw-bolder mt-4">Your Documentations</h6>
                                                            <div class="scrollbar">
                                                                <table class="w-100">
                                                                    <tbody>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Property Registration No.</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap  pb-3">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Business Registration No.</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content  pb-3">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border-top pt-3 text-nowrap">
                                                                                <h6 class="fw-semibold text-body-highlight mb-0">Taxpayer Identification No.</h6>
                                                                            </td>
                                                                            <td class="border-top px-3 pt-3 w-max-content">
                                                                                <p class="mb-0 w-max-content">:</p>
                                                                            </td>
                                            ...
                                            <div class="mt-4 text-body-tertiary form-icon-label ms-3 d-flex align-items-center">
                                                <button class="btn btn-primary px-md-5 px-3" type="submit">Done</button>
                                                <button class="btn btn-primary px-md-5 px-3 ms-2" type="submit">Next</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 text-body-tertiary form-icon-label ms-3" data-wizard-footer="data-wizard-footer">
