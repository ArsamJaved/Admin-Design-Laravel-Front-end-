...
<div class="content">
    <div id="lead-details">
        <div class="p-md-4 p-3">
            ...
            <div class="mb-9">
                <h3 class="mb-4 fw-bold">Add New Room</h3>
                    ...
                    <div class="row gx-0 gx-xl-5">
                        <div class="col-xl-4 order-xl-1">
                            <div class="scrollbar mb-4">
                                <ul class="nav justify-content-between flex-nowrap nav-wizard nav-wizard-vertical-xl" role="tablist">
                                    <li class="nav-item" role="presentation"><a class="nav-link active py-0 py-xl-3" href="#add-room-wizard-tab1" data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-file nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                                        ...
                                                        </svg><!-- <span class="fa-solid fa-file nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg><!-- <span class="fa-solid fa-check check-icon"></span> Font Awesome fontawesome.com --></span></span><span class="nav-item-title fs-9 fs-xl-8">Details</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-room-wizard-tab2" data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-dollar-sign nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="dollar-sign" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                                            ...
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg><!-- <span class="fa-solid fa-check check-icon"></span> Font Awesome fontawesome.com --></span></span><span class="nav-item-title fs-9 fs-xl-8">Pricing</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-room-wizard-tab3" data-bs-toggle="tab" data-wizard-step="3" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-grip nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="grip" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M128 136c0-22.1-17.9-40-40-40L40 96C17.9 96 0 113.9 0 136l0 48c0 22.1 17.9 40 40 40H88c22.1 0 40-17.9 40-40l0-48zm0 192c0-22.1-17.9-40-40-40H40c-22.1 0-40 17.9-40 40l0 48c0 22.1 17.9 40 40 40H88c22.1 0 40-17.9 40-40V328zm32-192v48c0 22.1 17.9 40 40 40h48c22.1 0 40-17.9 40-40V136c0-22.1-17.9-40-40-40l-48 0c-22.1 0-40 17.9-40 40zM288 328c0-22.1-17.9-40-40-40H200c-22.1 0-40 17.9-40 40l0 48c0 22.1 17.9 40 40 40h48c22.1 0 40-17.9 40-40V328zm32-192v48c0 22.1 17.9 40 40 40h48c22.1 0 40-17.9 40-40V136c0-22.1-17.9-40-40-40l-48 0c-22.1 0-40 17.9-40 40zM448 328c0-22.1-17.9-40-40-40H360c-22.1 0-40 17.9-40 40v48c0 22.1 17.9 40 40 40h48c22.1 0 40-17.9 40-40V328z"></path>
                                                        </svg><!-- <span class="fa-solid fa-grip nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg><!-- <span class="fa-solid fa-check check-icon"></span> Font Awesome fontawesome.com --></span></span><span class="nav-item-title fs-9 fs-xl-8">Amenities</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-room-wizard-tab4" data-bs-toggle="tab" data-wizard-step="4" aria-selected="false" tabindex="-1" role="tab">
                                            <div class="text-center d-inline-block d-xl-flex align-items-center gap-3"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-images nav-item-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="images" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                        ...
                                                        </svg><!-- <span class="fa-solid fa-images nav-item-icon"></span> Font Awesome fontawesome.com --><svg class="svg-inline--fa fa-check check-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
                                                        </svg><!-- <span class="fa-solid fa-check check-icon"></span> Font Awesome fontawesome.com --></span></span><span class="nav-item-title fs-9 fs-xl-8">Photos</span></div>
                                        </a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link py-0 py-xl-3" href="#add-room-wizard-tab5" data-bs-toggle="tab" data-wizard-step="5" aria-selected="false" tabindex="-1" role="tab">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xxl-8">
                                            <form id="addPropertyWizardForm1" data-wizard-form="1">
                                                <h4 class="mb-4 fw-bold">Room Details</h4>
                                                <h5 class="mb-2 fw-bold">Share your room details</h5>
                                                ...
                                                <div class="row gx-3 gx-sm-4 gy-3 mb-4">
                                                    ...
                                                    <div class="col-6 col-sm-4"><label class="mb-1 text-body-highlight fw-bold" for="adult">Adult</label>
                                                        <div class="input-group" data-quantity="data-quantity"><button class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="minus"><svg class="svg-inline--fa fa-minus" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                ...
                                                                </svg><!-- <span class="fa-solid fa-minus"></span> Font Awesome fontawesome.com --></button><input class="form-control input-spin-none text-center" id="adult" type="number" value="2"><button class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="plus"><svg class="svg-inline--fa fa-plus" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                                                </svg><!-- <span class="fa-solid fa-plus"></span> Font Awesome fontawesome.com --></button></div>
                                                    </div>
                                                ...
                                                <h5 class="mt-4 mb-2">Sleeping arrangements</h5>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xxl-8">
                                            <form id="addPropertyWizardForm2" data-wizard-form="2">
                                                ...
                                                <h5 class="mb-2">Base price per night</h5>
                                                <p class="mb-4 text-body-tertiary">Get a great value stay with us, starting at our base price per night.</p>
                                                <div class="nav nav-tabs mb-2" id="day-week-pricing" role="tablist">
                                                    <div class="form-check form-check-inline me-3"><input class="form-check-input active" type="radio" id="all-day-tab" name="dayWeekPricing" checked="checked" data-bs-toggle="tab" data-bs-target="#allDayPricing" aria-controls="allDayPricing" aria-selected="true" role="tab"><label class="form-check-label" for="all-day-tab">Across all days</label></div>
                                                    <div class="form-check form-check-inline"><input class="form-check-input" type="radio" id="day-of-week-tab" name="dayWeekPricing" data-bs-toggle="tab" data-bs-target="#dayOfWeekPricing" aria-controls="dayOfWeekPricing" aria-selected="false" tabindex="-1" role="tab"><label class="form-check-label" for="day-of-week-tab">By day of week</label></div>
                                                </div>
                                                <div class="tab-content">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row gx-2 justify-content-between">
                                                                    <div class="col col-sm-auto"><label class="mb-1 text-body-highlight fw-bold fs-9" for="date">Date</label>
                                                                        <div class="form-icon-container"><input class="form-control datetimepicker form-icon-input flatpickr-input" id="date" type="text" placeholder="Start date" data-options="{&quot;disableMobile&quot;:true,&quot;mode&quot;:&quot;range&quot;,&quot;minDate&quot;:&quot;today&quot;,&quot;dateFormat&quot;:&quot;d-m-y&quot;}" readonly="readonly"><svg class="svg-inline--fa fa-calendar-days form-icon fs-9 text-body-tertiary" data-fa-transform="up-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-days" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="" style="transform-origin: 0.4375em 0.4375em;">
                                                                                <g transform="translate(224 256)">
                                                                                    <g transform="translate(0, -32)  scale(1, 1)  rotate(0 0 0)">
                                                                                        <path fill="currentColor" d="M128 0c17.7 0 32 14.3 32 32V64H288V32c0-17.7 14.3-32 32-32s32 14.3 32 32V64h48c26.5 0 48 21.5 48 48v48H0V112C0 85.5 21.5 64 48 64H96V32c0-17.7 14.3-32 32-32zM0 192H448V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V192zm64 80v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm128 0v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H208c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H336zM64 400v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H208zm112 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H336c-8.8 0-16 7.2-16 16z" transform="translate(-224 -256)"></path>
                                                                                    </g>
                                                                                </g>
                                                                            </svg><!-- <span class="fa-solid fa-calendar-alt form-icon fs-9 text-body-tertiary" data-fa-transform="up-1"></span> Font Awesome fontawesome.com --></div>
                                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center gap-2 mt-4"><label class="fs-7 fw-bold text-body-emphasis" for="extraBedSwitch">Extra bed option</label>
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="row gx-3">
                                                            <div class="col-6 col-sm-4 col-xxl-5"><label class="mb-1 text-body-highlight fw-bold" for="number-of-bed-pricing">Number of bed</label>
                                                                <div class="input-group gap-1" data-quantity="data-quantity"><button class="btn btn-primary px-3 bg-body-emphasis bg-body-hover rounded" data-type="minus">-</button><input class="form-control flex-1 border-translucent input-spin-none text-center rounded" id="number-of-bed-pricing" type="number" value="2"><button class="btn btn-primary px-3 bg-body-emphasis bg-body-hover rounded" data-type="plus">+</button></div>
                                                            </div>
                                                ...
                                                <h5 class="mb-2 mt-4">Breakfast</h5>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active w-sm-60" id="breakfastInCluded" role="tabpanel" aria-labelledby="breakfast-included-tab" tabindex="0">
                                                        ...
                                                        <div class="text-center mt-4"><a class="fw-bold fs-9" href="#!"><svg class="svg-inline--fa fa-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                                                </svg><!-- <span class="fa-solid fa-plus me-2"></span> Font Awesome fontawesome.com -->Add more</a></div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-8">
                                            <form id="addPropertyWizardForm3" novalidate="novalidate" data-wizard-form="3">
                                                <div class="d-sm-flex flex-between-center gap-3">
                                                    <h4 class="mb-4 mb-sm-0">Amenities</h4>
                                                    <div class="row g-3">
                                                        <div class="col-sm-auto flex-sm-fill">
                                                            <div class="form-floating">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-auto"><button class="btn btn-primary"><svg class="svg-inline--fa fa-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                                ...
                                                <div class="accordion-button-arrow-icon accordion mt-2" id="generalAmenitiesAccordion">
                                                    <div class="accordion-item px-0 py-3">
                                                        <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight" type="button" data-bs-toggle="collapse" data-bs-target="#popularAmenities" aria-expanded="true" aria-controls="popularAmenities"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-fire" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="fire" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#foodAndDrink" aria-expanded="false" aria-controls="foodAndDrink"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-utensils" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="utensils" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#outdoorAndView" aria-expanded="false" aria-controls="outdoorAndView"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-umbrella-beach" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="umbrella-beach" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                    ...
                                                    <div class="accordion-item px-0 py-3">
                                                        <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accessibility" aria-expanded="false" aria-controls="accessibility"><span class="circle-icon-item me-3"><svg class="svg-inline--fa fa-universal-access" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="universal-access" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xxl-8">
                                            <form id="addPropertyWizardForm4" novalidate="novalidate" data-wizard-form="4">
                                                <h4 class="mb-4">Add room picture</h4>
                                ...
                                <div class="tab-pane" role="tabpanel" aria-labelledby="add-room-wizard-tab5" id="add-room-wizard-tab5">
                                    <div class="row g-0">
                                        <div class="col-xxl-10">
                                            <h4 class="mb-2">We’re building your listing</h4>
                                            ...
                                            <div class="alert alert-subtle-success alert-dismissible fade show mb-4" role="alert">
                                            ...
                                            <h5 class="text-body mb-3"> Room information<a class="fs-9 mx-2" href="#!">Edit</a></h5>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-border-all fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="border-all" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-file-pen fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-pen" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V299.6l-94.7 94.7c-8.2 8.2-14 18.5-16.8 29.7l-15 60.1c-2.3 9.4-1.8 19 1.4 27.8H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128zM549.8 235.7l14.4 14.4c15.6 15.6 15.6 40.9 0 56.6l-29.4 29.4-71-71 29.4-29.4c15.6-15.6 40.9-15.6 56.6 0zM311.9 417L441.1 287.8l71 71L382.9 487.9c-4.1 4.1-9.2 7-14.9 8.4l-60.1 15c-5.5 1.4-11.2-.2-15.2-4.2s-5.6-9.7-4.2-15.2l15-60.1c1.4-5.6 4.3-10.8 8.4-14.9z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-bed fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bed" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-person-shelter fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="person-shelter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                ...
                                                <div class="col-md-5 col-xxl-6">
                                                    <table class="table table-borderless mb-0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-user fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-children fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="children" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M160 0a64 64 0 1 1 0 128A64 64 0 1 1 160 0zM88 480V400H70.2c-10.9 0-18.6-10.7-15.2-21.1l31.1-93.4L57.5 323.3c-10.7 14.1-30.8 16.8-44.8 6.2s-16.8-30.7-6.2-44.8L65.4 207c22.4-29.6 57.5-47 94.6-47s72.2 17.4 94.6 47l58.9 77.7c10.7 14.1 7.9 34.2-6.2 44.8s-34.2 7.9-44.8-6.2l-28.6-37.8L265 378.9c3.5 10.4-4.3 21.1-15.2 21.1H232v80c0 17.7-14.3 32-32 32s-32-14.3-32-32V400H152v80c0 17.7-14.3 32-32 32s-32-14.3-32-32zM480 0a64 64 0 1 1 0 128A64 64 0 1 1 480 0zm-8 384v96c0 17.7-14.3 32-32 32s-32-14.3-32-32V300.5L395.1 321c-9.4 15-29.2 19.4-44.1 10s-19.4-29.2-10-44.1l51.7-82.1c17.6-27.9 48.3-44.9 81.2-44.9h12.3c33 0 63.7 16.9 81.2 44.9L619.1 287c9.4 15 4.9 34.7-10 44.1s-34.7 4.9-44.1-10L552 300.5V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V384H472z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-bath fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bath" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-person-booth fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="person-booth" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                            ...
                                            <h5 class="text-body mb-4 mt-5">Pricing<a class="fs-9 mx-2" href="#!">Edit</a></h5>
                                            <h6 class="mb-2">Across all days</h6>
                                            <h4 class="mb-0">$894</h4>
                                            <h5 class="text-body mb-3 mt-4">Amenities<a class="fs-9 mx-2" href="#!">Edit</a></h5>
                                            <div class="row gx-7 gx-xl-4 gx-xxl-7">
                                                <div class="col-md-7 col-xxl-6">
                                                    <table class="table table-borderless mb-0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-wifi fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="wifi" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-utensils fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="utensils" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M416 0C400 0 288 32 288 176V288c0 35.3 28.7 64 64 64h32V480c0 17.7 14.3 32 32 32s32-14.3 32-32V352 240 32c0-17.7-14.3-32-32-32zM64 16C64 7.8 57.9 1 49.7 .1S34.2 4.6 32.4 12.5L2.1 148.8C.7 155.1 0 161.5 0 167.9c0 45.9 35.1 83.6 80 87.7V480c0 17.7 14.3 32 32 32s32-14.3 32-32V255.6c44.9-4.1 80-41.8 80-87.7c0-6.4-.7-12.8-2.1-19.1L191.6 12.5c-1.8-8-9.3-13.3-17.4-12.4S160 7.8 160 16V150.2c0 5.4-4.4 9.8-9.8 9.8c-5.1 0-9.3-3.9-9.8-9L127.9 14.6C127.2 6.3 120.3 0 112 0s-15.2 6.3-15.9 14.6L83.7 151c-.5 5.1-4.7 9-9.8 9c-5.4 0-9.8-4.4-9.8-9.8V16zm48.3 152l-.3 0-.3 0 .3-.7 .3 .7z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-person-swimming fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="person-swimming" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-ban-smoking fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ban-smoking" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M99.5 144.8L178.7 224l96 96 92.5 92.5C335.9 434.9 297.5 448 256 448C150 448 64 362 64 256c0-41.5 13.1-79.9 35.5-111.2zM333.3 288l-32-32H384v32H333.3zm32 32H400c8.8 0 16-7.2 16-16V240c0-8.8-7.2-16-16-16H269.3L144.8 99.5C176.1 77.1 214.5 64 256 64c106 0 192 86 192 192c0 41.5-13.1 79.9-35.5 111.2L365.3 320zM256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM272 96c-8.8 0-16 7.2-16 16c0 26.5 21.5 48 48 48h32c8.8 0 16 7.2 16 16s7.2 16 16 16s16-7.2 16-16c0-26.5-21.5-48-48-48H304c-8.8 0-16-7.2-16-16s-7.2-16-16-16zM229.5 320l-96-96H112c-8.8 0-16 7.2-16 16v64c0 8.8 7.2 16 16 16H229.5z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-square-parking fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="square-parking" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM192 256h48c17.7 0 32-14.3 32-32s-14.3-32-32-32H192v64zm48 64H192v32c0 17.7-14.3 32-32 32s-32-14.3-32-32V288 168c0-22.1 17.9-40 40-40h72c53 0 96 43 96 96s-43 96-96 96z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-umbrella-beach fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="umbrella-beach" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M346.3 271.8l-60.1-21.9L214 448H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H544c17.7 0 32-14.3 32-32s-14.3-32-32-32H282.1l64.1-176.2zm121.1-.2l-3.3 9.1 67.7 24.6c18.1 6.6 38-4.2 39.6-23.4c6.5-78.5-23.9-155.5-80.8-208.5c2 8 3.2 16.3 3.4 24.8l.2 6c1.8 57-7.3 113.8-26.8 167.4zM462 99.1c-1.1-34.4-22.5-64.8-54.4-77.4c-.9-.4-1.9-.7-2.8-1.1c-33-11.7-69.8-2.4-93.1 23.8l-4 4.5C272.4 88.3 245 134.2 226.8 184l-3.3 9.1L434 269.7l3.3-9.1c18.1-49.8 26.6-102.5 24.9-155.5l-.2-6zM107.2 112.9c-11.1 15.7-2.8 36.8 15.3 43.4l71 25.8 3.3-9.1c19.5-53.6 49.1-103 87.1-145.5l4-4.5c6.2-6.9 13.1-13 20.5-18.2c-79.6 2.5-154.7 42.2-201.2 108z"></path>
                                                ...
                                                <div class="col-md-5 col-xxl-6">
                                                    <table class="table table-borderless mb-0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-wine-glass fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="wine-glass" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M32.1 29.3C33.5 12.8 47.4 0 64 0H256c16.6 0 30.5 12.8 31.9 29.3l14 168.4c6 72-42.5 135.2-109.9 150.6V448h48c17.7 0 32 14.3 32 32s-14.3 32-32 32H160 80c-17.7 0-32-14.3-32-32s14.3-32 32-32h48V348.4C60.6 333 12.1 269.8 18.1 197.8l14-168.4zm56 98.7H231.9l-5.3-64H93.4l-5.3 64z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-people-roof fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="people-roof" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M335.5 4l288 160c15.4 8.6 21 28.1 12.4 43.5s-28.1 21-43.5 12.4L320 68.6 47.5 220c-15.4 8.6-34.9 3-43.5-12.4s-3-34.9 12.4-43.5L304.5 4c9.7-5.4 21.4-5.4 31.1 0zM320 160a40 40 0 1 1 0 80 40 40 0 1 1 0-80zM144 256a40 40 0 1 1 0 80 40 40 0 1 1 0-80zm312 40a40 40 0 1 1 80 0 40 40 0 1 1 -80 0zM226.9 491.4L200 441.5V480c0 17.7-14.3 32-32 32H120c-17.7 0-32-14.3-32-32V441.5L61.1 491.4c-6.3 11.7-20.8 16-32.5 9.8s-16-20.8-9.8-32.5l37.9-70.3c15.3-28.5 45.1-46.3 77.5-46.3h19.5c16.3 0 31.9 4.5 45.4 12.6l33.6-62.3c15.3-28.5 45.1-46.3 77.5-46.3h19.5c32.4 0 62.1 17.8 77.5 46.3l33.6 62.3c13.5-8.1 29.1-12.6 45.4-12.6h19.5c32.4 0 62.1 17.8 77.5 46.3l37.9 70.3c6.3 11.7 1.9 26.2-9.8 32.5s-26.2 1.9-32.5-9.8L552 441.5V480c0 17.7-14.3 32-32 32H472c-17.7 0-32-14.3-32-32V441.5l-26.9 49.9c-6.3 11.7-20.8 16-32.5 9.8s-16-20.8-9.8-32.5l36.3-67.5c-1.7-1.7-3.2-3.6-4.3-5.8L376 345.5V400c0 17.7-14.3 32-32 32H296c-17.7 0-32-14.3-32-32V345.5l-26.9 49.9c-1.2 2.2-2.6 4.1-4.3 5.8l36.3 67.5c6.3 11.7 1.9 26.2-9.8 32.5s-26.2 1.9-32.5-9.8z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-table-tennis-paddle-ball fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-tennis-paddle-ball" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M480 288c-50.1 0-93.6 28.8-114.6 70.8L132.9 126.3l.6-.6 60.1-60.1c87.5-87.5 229.3-87.5 316.8 0c67.1 67.1 82.7 166.3 46.8 248.3C535.8 297.6 509 288 480 288zM113.3 151.9L354.1 392.7c-1.4 7.5-2.1 15.3-2.1 23.3c0 23.2 6.2 44.9 16.9 63.7c-3 .2-6.1 .3-9.2 .3H357c-33.9 0-66.5-13.5-90.5-37.5l-9.8-9.8c-13.1-13.1-34.6-12.4-46.8 1.7L152.2 501c-5.8 6.7-14.2 10.7-23 11s-17.5-3.1-23.8-9.4l-32-32c-6.3-6.3-9.7-14.9-9.4-23.8s4.3-17.2 11-23l66.6-57.7c14-12.2 14.8-33.7 1.7-46.8l-9.8-9.8c-24-24-37.5-56.6-37.5-90.5v-2.7c0-22.8 6.1-44.9 17.3-64.3zM480 320a96 96 0 1 1 0 192 96 96 0 1 1 0-192z"></path>
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-snowflake fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="snowflake" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                            ...
                                                            <tr>
                                                                <td class="text-nowrap py-2">
                                                                    <div class="d-flex gap-2"><svg class="svg-inline--fa fa-tv fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tv" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                                            <path fill="currentColor" d="M64 64V352H576V64H64zM0 64C0 28.7 28.7 0 64 0H576c35.3 0 64 28.7 64 64V352c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM128 448H512c17.7 0 32 14.3 32 32s-14.3 32-32 32H128c-17.7 0-32-14.3-32-32s14.3-32 32-32z"></path>
                                            ...
                                            <h5 class="text-body mb-4 mt-4">Picture<a class="fs-9 mx-2" href="#!">Edit</a></h5>
                                            <div class="row g-3">
                                            ...
                                            <div class="mt-4 d-flex flex-wrap gap-2"><button class="btn btn-danger" type="button">Discard</button><button class="btn btn-primary" type="button">Save draft</button><button class="btn btn-primary px-6 px-sm-11" type="submit">Open for Booking</button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-4 d-flex flex-wrap gap-2" data-wizard-footer="data-wizard-footer"><button class="btn btn-danger" type="button">Discard</button><button class="btn btn-primary" type="button">Save draft</button><button class="btn btn-primary px-6 px-sm-11" type="submit" data-wizard-next-btn="data-wizard-next-btn">Continue</button></div>
                        </div>
                    </div>
                </div>
            </div>
