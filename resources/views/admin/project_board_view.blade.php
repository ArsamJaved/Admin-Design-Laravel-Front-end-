            ...
            <div class="row justify-content-between align-items-end mb-4 g-3">
                ...
                <div class="col-12 col-sm-auto">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{url('project_board_view')}}" title="Board View" class="btn btn-outline-secondary px-3 me-1 border-0 text-body" href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Board view">
            ...
            <div class="row g-3 mb-9">
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/51.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="z-2">
                                    <button class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                            ...
                            <h4 class="text-white fw-bold line-clamp-2">Project Doughnut Dungeon</h4>
                        </div>
                        <a class="stretched-link" href="#projectsBoardViewModal" data-bs-toggle="modal" data-bs-target="#projectsBoardViewModal"></a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/52.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                                <div class="z-2">
                                    <button class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                                        <svg class="svg-inline--fa fa-ellipsis-vertical" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-vertical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512" data-fa-i2svg="">
                                            <path fill="currentColor" d="M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z"></path>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/53.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                                <div class="z-2">
                            ...
                            <h4 class="text-white fw-bold line-clamp-2">Harnessing stupidity from Jerry the Mortypop</h4>
                        </div>
                        <a class="stretched-link" href="#projectsBoardViewModal" data-bs-toggle="modal"></a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/54.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-info" data-bs-theme="light">Inactive</span>
                                <div class="z-2">
                                    <button class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                                        <svg class="svg-inline--fa fa-ellipsis-vertical" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-vertical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512" data-fa-i2svg="">
                                            <path fill="currentColor" d="M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z"></path>
                            ...
                            <h4 class="text-white fw-bold line-clamp-2">Making the Butterflies shoot each other dead</h4>
                        </div>
                        <a class="stretched-link" href="#projectsBoardViewModal" data-bs-toggle="modal"></a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/55.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                                <div class="z-2">
                            ...
                            <h4 class="text-white fw-bold line-clamp-2">The chewing gum attack</h4>
                        </div>
                        <a class="stretched-link" href="#projectsBoardViewModal" data-bs-toggle="modal"></a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/56.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-primary" data-bs-theme="light">Ongoing</span>
                                <div class="z-2">
                            ...
                            <h4 class="text-white fw-bold line-clamp-2">Water resistant mosquito killer gun, version 2.1.0</h4>
                        </div>
                        <a class="stretched-link" href="#projectsBoardViewModal" data-bs-toggle="modal"></a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
                    <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                        <div class="bg-holder" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url(https://prium.github.io/phoenix/v1.18.0/assets/img/generic/57.png)"></div>
                        <div class="position-relative h-100 d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                                <div class="z-2">
...
<!-- Modal -->
<div class="modal fade" id="projectsBoardViewModal" tabindex="-1" aria-labelledby="projectsBoardViewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content overflow-hidden">
            <div class="modal-header position-relative p-0">
                <input class="d-none" id="projectModalTwoCoverInput" type="file">
                <label class="position-absolute top-0 start-0" for="projectModalTwoCoverInput">
                    <span class="project-modal-btn d-inline-block rounded-2 py-2 px-3 fs-9 fw-bolder mt-3 ms-3 cursor-pointer">

                        <svg class="svg-inline--fa fa-image me-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="image" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                ...
                <button class="btn btn-circle project-modal-btn position-absolute end-0 top-0 mt-3 me-3" data-bs-dismiss="modal">

                    <svg class="svg-inline--fa fa-xmark text-body dark__text-gray-100" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                        <path fill="currentColor" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"></path>
                    </svg>
                </button>
                <img class="w-100" src="https://prium.github.io/phoenix/v1.18.0/assets/img/generic/43.png" alt="" style="max-height: 280px;min-height: 150px;">
            </div>
            <div class="modal-body p-0">
                <div class="row gx-0 gy-3 border-bottom px-5 py-4 p-xl-0">
                    <div class="col-12 col-lg-5 border-end">
                        <div class="row h-100 align-items-center px-lg-5 justify-content-between justify-content-xl-start">
                            <div class="col-auto">
                                <p class=" fs-10 fw-semibold mb-0">Created</p>
                                <p class="text-body-highlight fs-9 mb-0">Jan 3, 3:24 pm</p>
                            </div>
                            <div class="col-7 col-lg-6">
                                <div class="flatpickr-input-container flatpickr-input-sm">
                                    <input class="form-control form-control-sm ps-6 datetimepicker flatpickr-input" id="datepicker" type="text" data-options="{&quot;dateFormat&quot;:&quot;M j, Y&quot;,&quot;disableMobile&quot;:true,&quot;defaultDate&quot;:&quot;Mar 1, 2022&quot;}" readonly="readonly"><span class="uil uil-calendar-alt flatpickr-icon "></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-7">
                        <div class="px-lg-5 py-xl-4">
                            <div class="row g-2 align-items-center justify-content-between">
                                <div class="col-auto col-12 col-lg-auto d-flex flex-1">
                                    <div class="dropdown"><button class="d-none d-sm-block btn btn-outline-secondary dropdown-toggle dropdown-caret-none d-flex align-items-center me-2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Add to card
                                            <svg class="svg-inline--fa fa-plus ms-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                            </svg>
                                        </button>
                                        <button class="d-sm-none btn btn-icon btn-icon-lg btn-subtle-secondary dropdown-toggle dropdown-caret-none d-flex align-items-center me-2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end px-2"><button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-user-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                                                ...
                                                Assignee</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-tag me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tag" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                ...
                                                Labels</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-paperclip me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="paperclip" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                ...
                                                Attachments</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-square-check me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="square-check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                ...
                                                Checklist</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100">
                                                <svg class="svg-inline--fa fa-calendar-days me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-days" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    ...
                                    <div class="dropdown"><button class="btn btn-outline-secondary rounded-2 me-2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis-vertical" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-vertical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z"></path>
                                            </svg>
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-end px-2">
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-arrow-right me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                    <path fill="currentColor" d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"></path>
                                                </svg>
                                                Move</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-copy me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                ...
                                                Copy</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-trash me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                ...
                                                Remove</button>
                                            <button class="btn brn-sm btn-outline-secondary rounded-2 d-flex align-items-center w-100 mb-2">
                                                <svg class="svg-inline--fa fa-box-archive me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="box-archive" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                ...
                                <div class="col-auto col-lg-auto d-flex">
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown-toggle dropdown-caret-none d-flex align-items-center me-2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Review

                                            <svg class="svg-inline--fa fa-angle-down ms-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    ...
                                    <div class="btn btn-sm btn-outline-secondary btn-icon btn-icon-lg">
                ...
                <div class="row g-0">
                    <div class="col-12 col-xl-5 border-end">
                        <div class="px-5 px-lg-6 py-4">
                            <h4 class="fw-bolder mb-5">It was popularised in the 1960s with the release of Letraset</h4>
                            <div class="d-flex align-items-center mb-5">
                                <p class="text-body-highlight fw-700 mb-0 me-2">64%</p>
                                <div class="progress flex-1 w-100" style="height: 6px">
                                    ...
                                    <div class="dropdown"><a class="dropdown-toggle dropdown-caret-none d-inline-block" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                        ...
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden" style="width: 320px;">
                                            <div class="position-relative">
                                                ...
                                                <div class="p-3">
                                                    <div class="text-end"><button class="btn p-0 me-2">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <div class="d-flex flex-center mb-3">
                                                            ...
                                                            <svg class="svg-inline--fa fa-circle  mx-1" data-fa-transform="shrink-10 up-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.375em;">
                                            ...
                                            <div class="bg-body-emphasis">
                                                <div class="p-3 border-bottom border-translucent">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="d-flex"><button class="btn btn-phoenix-secondary btn-icon btn-icon-lg me-2">
                                                            ...
                                                            </button><button class="btn btn-phoenix-secondary btn-icon btn-icon-lg me-2">
                                                            ...
                                                            </button><button class="btn btn-phoenix-secondary btn-icon btn-icon-lg">
                                                            ...
                                                            </button></div><button class="btn btn-phoenix-primary">
                                                ...
                                                <ul class="nav d-flex flex-column py-3 border-bottom">
                                                    <li class="nav-item"><a class="nav-link px-3 d-flex justify-content-between" href="#!"> <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard me-2 text-body d-inline-block">
                                                                <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path>
                                                                <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
                                                            </svg><span class="text-body-highlight flex-1">Assigned Projects</span>
                                                    ...
                                                    <li class="nav-item"><a class="nav-link px-3 d-flex justify-content-between" href="#!"> <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart me-2 text-body">
                                                                <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                                                                <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
                                                            </svg><span class="text-body-highlight flex-1">View activiy</span>
                                                            <svg class="svg-inline--fa fa-chevron-right fs-11" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                                                <path fill="currentColor" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path>
                                                            </svg>
                                                        </a></li>
                        ...
                        <div class="bg-body-highlight px-5 px-lg-6 py-4">
                            <div class="row justify-contnet-between border-bottom border-translucent g-0 gy-2 pb-3">
                                <div class="col-12 col-sm">
                                    <p class="fs-9 text-body-secondary mb-2"><a class="fw-semibold" href="#!">Anthony Van Dyck </a>uploaded a file </p><img class="rounded-2 mb-2" src="https://prium.github.io/phoenix/v1.18.0/assets/img/generic/42.png" alt="" width="220">
                            ...
                            <div class="row justify-contnet-between border-bottom border-translucent g-0 gy-1 py-3 align-items-center">
                                <div class="col-12 col-sm">
                                    ...
                                    <div class="d-flex">
                                        <p class="mb-0 fs-9 fw-semibold text-body-highlight">
                                            <svg class="svg-inline--fa fa-circle text-primary" data-fa-transform="shrink-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.5em;">
                                                <g transform="translate(256 256)">
                                        ...
                                        <span class="text-body-secondary fs-9 mx-2">to</span>
                                        <p class="mb-0 fs-9 fw-semibold text-body-highlight">
                                            <svg class="svg-inline--fa fa-circle text-primary" data-fa-transform="shrink-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.5em;">
                                                <g transform="translate(256 256)">
                                                    <g transform="translate(0, 0)  scale(0.5, 0.5)  rotate(0 0 0)">
                            ...
                            <div class="mt-4"><textarea class="form-control form-control mb-3" rows="3" placeholder="Add comment"></textarea>
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex">
                                        <button class="btn btn-sm ps-0 pe-2 py-0">
                                            <svg class="svg-inline--fa fa-image fs-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="image" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zM323.8 202.5c-4.5-6.6-11.9-10.5-19.8-10.5s-15.4 3.9-19.8 10.5l-87 127.6L170.7 297c-4.6-5.7-11.5-9-18.7-9s-14.2 3.3-18.7 9l-64 80c-5.8 7.2-6.9 17.1-2.9 25.4s12.4 13.6 21.6 13.6h96 32H424c8.9 0 17.1-4.9 21.2-12.8s3.6-17.4-1.4-24.7l-120-176zM112 192a48 48 0 1 0 0-96 48 48 0 1 0 0 96z"></path>
                                            </svg>
                                        </button>
                                        <button class="btn btn-sm px-2 py-0">
                                            <svg class="svg-inline--fa fa-calendar-days fs-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-days" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M128 0c17.7 0 32 14.3 32 32V64H288V32c0-17.7 14.3-32 32-32s32 14.3 32 32V64h48c26.5 0 48 21.5 48 48v48H0V112C0 85.5 21.5 64 48 64H96V32c0-17.7 14.3-32 32-32zM0 192H448V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V192zm64 80v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm128 0v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H208c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H336zM64 400v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H208zm112 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H336c-8.8 0-16 7.2-16 16z"></path>
                                            </svg>
                                        </button>
                                        <button class="btn btn-sm px-2 py-0">
                                            <svg class="svg-inline--fa fa-location-dot fs-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-dot" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path>
                                            </svg>
                                        </button>
                                        <button class="btn btn-sm px-2 py-0">
                                            <svg class="svg-inline--fa fa-tag fs-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tag" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M0 80V229.5c0 17 6.7 33.3 18.7 45.3l176 176c25 25 65.5 25 90.5 0L418.7 317.3c25-25 25-65.5 0-90.5l-176-176c-12-12-28.3-18.7-45.3-18.7H48C21.5 32 0 53.5 0 80zm112 32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"></path>
                                            </svg>
                                        </button>
                                    </div>
                        ...
                        <div class="px-5 px-lg-6 py-4">
                                ...
                                <div class="me-n3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex mb-1">
                                            <svg class="svg-inline--fa fa-image me-2  fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="image" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                <path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zM323.8 202.5c-4.5-6.6-11.9-10.5-19.8-10.5s-15.4 3.9-19.8 10.5l-87 127.6L170.7 297c-4.6-5.7-11.5-9-18.7-9s-14.2 3.3-18.7 9l-64 80c-5.8 7.2-6.9 17.1-2.9 25.4s12.4 13.6 21.6 13.6h96 32H424c8.9 0 17.1-4.9 21.2-12.8s3.6-17.4-1.4-24.7l-120-176zM112 192a48 48 0 1 0 0-96 48 48 0 1 0 0 96z"></path>
                                            </svg>

                                            <p class="text-body-highlight mb-0 lh-1">Silly_sight_1.png</p>
                                        </div><button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                                    ...
                                    <p class="fs-9  mb-2"><span>768 kb</span><span class="text-body-quaternary mx-1">| </span><a href="#!">Shantinan Mekalan </a><span class="text-body-quaternary mx-1">| </span><span class="text-nowrap">21st Dec, 12:56 PM</span></p><img class="rounded-2" src="https://prium.github.io/phoenix/v1.18.0/assets/img/generic/40.png" alt="">
                                </div>
                            </div>
                            <div class="border-top py-3">
                                <div class="me-n3">
                                    ...
                                    <p class="fs-9  mb-1"><span>12.8 mb</span><span class="text-body-quaternary mx-1">| </span><a href="#!">Yves Tanguy </a><span class="text-body-quaternary mx-1">| </span><span class="text-nowrap">19th Dec, 08:56 PM</span></p>
                                </div>
                            </div>
                                ...
                                <div class="me-n3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center mb-1">
                                            <svg class="svg-inline--fa fa-file-lines me-2 fs-9 " aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-lines" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                    ...
                                    <p class="fs-9  mb-1"><span>123 kb</span><span class="text-body-quaternary mx-1">|</span><a href="#!">Shantinan Mekalan</a><span class="text-body-quaternary mx-1">|</span><span class="text-nowrap">12th Dec, 12:56 PM</span></p>
                                </div>
                            </div><label class="btn btn-link p-0" for="customFile">
                                <svg class="svg-inline--fa fa-plus me-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path>
                                </svg>
                                Add file(s)</label><input class="d-none" id="customFile" type="file">
                        </div>
                    </div>
                </div>
            </div>
